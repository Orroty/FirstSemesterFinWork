...
Добавляет строку data в массив arr и удовлетворяющих условию длина строки <= n в массив 2

атрибут 

> - data - строка для добавления в массивы
...
Ввод строки, разбиение по сплитеру  непустой входной строки, добавление результатов разделения в массив 1  и удовлетворяющих условию длина строки <=n в массив 2. Выход осуществляется по нажатию клавиши Esc.
...
Ввод и добавление непустой входной строки в массив 1 и удовлетворяющих условию длина строки <= n в массив 2. Выход осуществляется по нажатию клавиши Esc.
...
Отчистка 1 массива и уменьшение counter до 0

### Fin ###

Выполнено в программе Visual Studio
